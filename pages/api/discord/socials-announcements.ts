...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const channelId = '1158094335238209586'; // Social's Nightclub announcements channel
    const guildId = '694912331267964961'; // Social's Nightclub guild ID
    ...
    console.error('Error fetching Social\'s announcements:', error);
